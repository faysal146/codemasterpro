    ...
    return (
        <MDXProvider components={shortcodes}>
            <WithSiderbar>
                ...
                <section className="">
                    {relatedPostsKeys.length &&
                        relatedPostsKeys.map((postkey) => (
                            <div
                                key={postkey}
                                className="mb-3 py-6 px-3 bg-gray-800 rounded shadow-md"
                            >
                                <h3 className="mb-2 text-lg text-emerald-400">
                                    More {postkey} Courses
                                </h3>
