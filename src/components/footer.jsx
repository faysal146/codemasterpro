...
import Logo from './codemaster/logo';

const footer = () => (
    <footer className="container mx-auto bg-gray-800 rounded my-4">
        <div className="px-4 pt-10 pb-8 mx-auto sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row sm:items-start md:items-center lg:items-start sm:px-2 md:px-0">
                <div>
                    <Logo />
                ...
                <div className="flex-grow mt-5 lg:mt-0">
                    ...
                    <ul className="flex flex-col md:flex-row mt-5 lg:mt-16 md:space-x-4 space-y-4 md:space-y-0 text-sm lg:text-base footer-link justify-center">
                        ...
                        <Link to="/privacy-policy" className="hover:opacity-75">
                            Privacy Policy
                        </Link>
                        <Link to="/terms-of-use" className="hover:opacity-75">
                            Terms Of Use
                        </Link>
            ...
            <div className="flex items-center justify-center mt-8 text-sm">
                <span className="block">
                    © Copyright CodeMaster {new Date().getFullYear()}. All Rights Reserved.
                </span>
            </div>
        </div>
    </footer>
